        ...
        try {
            switch (this.type) {
                case "resetPswd":
                    ...
                    this.content = `<div>${process.env.SERVER_HOST}:${process.env.SERVER_PORT} 에서 ${this.user_id} 님이 비밀번호 초기화를 요청하였습니다.</div><br>
                ...
                case "authJoin":
                    ...
                    this.content = `<div>${process.env.SERVER_HOST}:${process.env.SERVER_PORT} 에서 ${this.user_id} 님이 가입을 요청 하셨습니다.</div><br>
                ...
                case "authEdit":
                    ...
                    this.content = `<div>${process.env.SERVER_HOST}:${process.env.SERVER_PORT} 에서 ${this.user_id} 님이 회원 정보 변견을 요청 하셨습니다.</div><br>
